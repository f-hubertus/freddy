...
# Adjusted for Blasting only!
# v0.01

use strict;
use Getopt::Long;
print STDERR "***Use BLAST_lib *** \n";
use lib '/scratch2/floris/function_prediction/FFPred2/featurama/blast_lib'; # This needs to be set to the full path to the Perl lib folder.
use PsiPred;
use DisoPred;
#use LowComplex;
use Memsat;
...
#use SeqFeat;
#use SigP;
print STDERR "***Start Blast_features.pl*** \n";
my $root_directory = '/scratch2/floris/function_prediction/FFPred2'; # This needs to be set to the full path to the main FFPred2 folder.
my $relative_path_CONFIG = 'CONFIGBLAST';
...
print STDERR "***End Blast_features.pl*** \n";
...
sub readConfig
{
    ...
    open(CONFIG, "<", "$rootdir/$rel_path_CONFIG") or die "Cannot read CONFIGBLAST: $!\n";
