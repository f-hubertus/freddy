...
# Disabled lines 128 through 138 for FFPred prediction with manual BLAST input

use strict;
use Getopt::Long;
use lib '/home/floris/galaxy-dist/tools/function_prediction/FFPred2/featurama/no_blast_lib'; # This needs to be set to the full path to the Perl lib folder.
use PsiPred;
use DisoPred;
use LowComplex;
use Memsat;
...
my $root_directory = '/home/floris/galaxy-dist/tools/function_prediction/FFPred2'; # This needs to be set to the full path to the main FFPred2 folder.
...
sub run
{
    ...
    print STDOUT "Running " . join(', ', @blastPreds) . "\n\n";
    
    unless ($orphan)
    {
	print STDOUT "Skipping PsiBlast \n";        
...
sub run_OLD
{
    ...
    unless ($orphan)
    {
        print STDOUT "Running PSIPRED, DISOPRED, MEMSAT\n\n";
...
sub check_OLD
{
    ...
    print STDOUT "PsiPred/DisoPred/MemsatSVM : success\n\n";
